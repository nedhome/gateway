	...
	<section>
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true">
                ...
                <!--</el-form-item>-->
                <el-form-item>
					<el-input v-model="id" placeholder="模块ID"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="secrets" highlight-current-row @selection-change="selsChange" style="width: 100%;margin-top: 10px">
            ...
            <el-table-column prop="moduleId"  label="模块ID" width="300" sortable>
            </el-table-column>
			<el-table-column prop="moduleName" label="模块名称" width="180" sortable>
			</el-table-column>
			<el-table-column prop="moduleIp" label="IP" width="150" sortable>
			</el-table-column>
			<el-table-column prop="modulePort" label="端口" width="100" sortable>
			</el-table-column>
			<el-table-column prop="thresholdCpu" label="CPU阈值" width="130" show-overflow-tooltip sortable>
			</el-table-column>
			<el-table-column prop="thresholdMem" label="内存阈值" width="130" sortable>
			</el-table-column>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false" >
			<el-form :model="addForm" label-width="120px" :rules="rule1" ref="addForm">
				...
				<el-form-item label="阻塞线程占用率">
					...
					<span class="thread">(0~100) 0表示不监控阻塞线程</span>
				</el-form-item>
		...
		methods: {
          ...
          // },
			...
			handleEdit: function (index, row) {
				...
				this.editForm.cpu = this.editForm.thresholdCpu;
                this.editForm.thread = this.editForm.thresholdThreadNum;
                this.editForm.memory = this.editForm.thresholdMem;
			},
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
                      ...
                      $.ajax({
                        ...
                        type:"POST",
                        url: 'http://172.16.70.191:8060/gateway/config/update',
                        data:that.editForm,
                        dataType:"json",
                        success: function(response){
                          closeLoading()
